            ...
            <Accordion type="single" collapsible className="w-full space-y-4">
              {[
                ...
                <AccordionItem
                  key={idx}
                  value={`item-${idx}`}
                  className="border-2 px-6 bg-white rounded-lg hover:shadow-md transition-all"
                >
                  <AccordionTrigger className="text-xl font-bold text-purple-950 hover:no-underline hover:text-purple-700 text-left">
                    {faq.q}
                  </AccordionTrigger>
