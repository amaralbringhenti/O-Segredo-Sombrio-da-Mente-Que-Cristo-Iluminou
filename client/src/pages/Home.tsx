    ...
    <div className="min-h-screen">
      ...
      >
        ...
        <button
          ...
          className="absolute bottom-8 left-1/2 -translate-x-1/2 animate-bounce cursor-pointer hover:opacity-80 transition-opacity focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-400 focus-visible:ring-offset-2 focus-visible:ring-offset-purple-950 rounded-full"
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                ...
                <strong>neurociência confirma</strong> o que o Espírito já
                dizia: a luz da verdade em Cristo{" "}
        ...
        <div className="container">
          <div className="text-center space-y-4 mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Uma jornada estruturada em três partes para transformar sua mente
              e renovar sua identidade em Cristo
            </p>
          </div>
              ...
              <CardContent className="p-8 md:p-12">
                <div className="space-y-6 text-white">
                  ...
                  <p className="text-lg text-gray-200 leading-relaxed">
                    <strong>
                      Cristão | Hipnoterapeuta | Master PNL | Coach
                    </strong>
                  </p>

                  <p className="text-lg text-gray-200 leading-relaxed">
                    Marcio Bringhenti é um pioneiro na integração entre fé
                    cristã e neurociência aplicada. Com formação em Programação
